                  ...
                  children: [
                    ...
                    DefaultStreamBuilder(
                      ...
                      builder: (_, friends) {
                        ...
                        final received = friends.where(
                          (element) => element.status == FriendStatus.requestReceived,
                        );
                        final sent = friends.where(
                          (element) => element.status == FriendStatus.requestSent,
                        );
                        final accepted = friends.where(
                          (element) => element.status == FriendStatus.accepted,
                        );
