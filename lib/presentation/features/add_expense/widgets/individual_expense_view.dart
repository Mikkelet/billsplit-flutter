...
class IndividualExpenseView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isPayer = cubit.state.groupExpense.payer.uid == person.uid;
    return Container(
      decoration: isPayer
          ? BoxDecoration(
        ...
        children: [
          ...
          if (showExpense)
            Flexible(
              ...
              child: Builder(
                builder: (context) {
                  final currency = cubit.state.groupExpense.currency;
  ...
  num getTotalForUser(AddExpenseBloc cubit) {
    return cubit.state.groupExpense.getSharedExpensesForPerson(person);
  }
}
