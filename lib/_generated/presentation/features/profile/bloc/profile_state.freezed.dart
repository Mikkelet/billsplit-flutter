...
abstract mixin class $ProfileStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, ProfileStateEvents event});
}
...
extension ProfileStatePatterns on ProfileState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isLoading, ProfileStateEvents event)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ProfileState() when $default != null:
        return $default(_that.isLoading, _that.event);
      case _:
        return orElse();
    }
  }
...
class _ProfileState implements ProfileState {
  const _ProfileState(
      {this.isLoading = false, this.event = ProfileStateEvents.none});
  ...
  @override
  @JsonKey()
  final ProfileStateEvents event;
