...
class DeleteProfilePictureUseCase {
  ...
  Future<Person> launch() async {
    if (_authRepository.loggedInUser.pfpUrl.isNotEmpty) {
      await _storageProvider.deleteProfilePicture(_authRepository.loggedInUser.uid);
    }
    await _authProvider.updateProfilePicture(null);
    return _authRepository.loggedInUser.copyWith(pfpUrl: "");
  }
}
