...
mixin _$UpdatePhoneNumberState {
  ...
  $UpdatePhoneNumberStateCopyWith<UpdatePhoneNumberState> get copyWith =>
      _$UpdatePhoneNumberStateCopyWithImpl<UpdatePhoneNumberState>(
          this as UpdatePhoneNumberState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UpdatePhoneNumberState &&
  ...
  int get hashCode => Object.hash(
      runtimeType, isLoading, errorMessage, phoneNumber, countryCode);
...
abstract mixin class $UpdatePhoneNumberStateCopyWith<$Res> {
  factory $UpdatePhoneNumberStateCopyWith(UpdatePhoneNumberState value,
          $Res Function(UpdatePhoneNumberState) _then) =
      _$UpdatePhoneNumberStateCopyWithImpl;
  @useResult
  $Res call(
      {bool isLoading,
      String errorMessage,
...
extension UpdatePhoneNumberStatePatterns on UpdatePhoneNumberState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UpdatePhoneNumberState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isLoading, String errorMessage, String phoneNumber,
            String countryCode)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UpdatePhoneNumberState() when $default != null:
        return $default(_that.isLoading, _that.errorMessage, _that.phoneNumber,
            _that.countryCode);
      case _:
        return orElse();
    }
...
class _UpdatePhoneNumberState implements UpdatePhoneNumberState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UpdatePhoneNumberStateCopyWith<_UpdatePhoneNumberState> get copyWith =>
      __$UpdatePhoneNumberStateCopyWithImpl<_UpdatePhoneNumberState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UpdatePhoneNumberState &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
            (identical(other.errorMessage, errorMessage) ||
                other.errorMessage == errorMessage) &&
...
/// @nodoc
abstract mixin class _$UpdatePhoneNumberStateCopyWith<$Res>
    implements $UpdatePhoneNumberStateCopyWith<$Res> {
  factory _$UpdatePhoneNumberStateCopyWith(_UpdatePhoneNumberState value,
          $Res Function(_UpdatePhoneNumberState) _then) =
      __$UpdatePhoneNumberStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isLoading,
