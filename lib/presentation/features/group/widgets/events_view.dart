...
class EventsView extends StatelessWidget {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final shouldShowProfilePictureLeft =
                    event.createdBy.uid != context.user.uid && event is! Payment;
                          ...
                          children: [
                            if (shouldShowProfilePictureLeft)
                              Padding(
                                ...
                                child: _createdByProfilePicture(event.createdBy, isLatestIndex),
                              ),
                            Flexible(child: ExpenseEventView(groupExpense: event)),
  ...
  bool _isLatestIndex(int index, Event event, List<Event> events) {
    try {
      return events[index - 1].createdBy.uid != event.createdBy.uid || events[index - 1] is Payment;
    } catch (e) {
      return true;
    }
  }
